...
class Grid2D(Grid):
    ...
    def __init__(self, ca_config, transition_func):
        ...
        #for x in range(0, 49):
            #for y in range (0, 49):
               # self.wrapping_grid[49-x, 49-y].fill(ca_config.states[2])

        #for x in range(5, 15):
            #for y in range (35, 40):
                #self.wrapping_grid[49-x, 49-y].fill(ca_config.states[1])

        #for x in range(32, 35):
            #for y in range (15, 45):
                #self.wrapping_grid[49-x, 49-y].fill(ca_config.states[4])

        #for x in range(15, 25):
            #for y in range (9, 20):
                #self.wrapping_grid[49-x, 49-y].fill(ca_config.states[6])

        self.wrapping_grid.fill(ca_config.states[1])
